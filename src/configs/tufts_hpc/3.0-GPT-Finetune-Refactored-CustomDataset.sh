#!/bin/bash
#SBATCH -J 6_29_22_2_18_gpt_finetune_refactored_customdataset #job name
...
CONFIG_PATH=${PROJECT_PATH}src/configs/model_configs/1.0-GPT-Finetune-CustomDataset-HPC.yaml
